...
public class Meal implements Parcelable {
    ...
    public List<Pair<String, String>> getIngredientsWithMeasures() {
        ...
        if (strIngredient1 != null && !strIngredient1.isEmpty()) list.add(new Pair<>(strIngredient1, strMeasure1));
        if (strIngredient2 != null && !strIngredient2.isEmpty()) list.add(new Pair<>(strIngredient2, strMeasure2));
        if (strIngredient3 != null && !strIngredient3.isEmpty()) list.add(new Pair<>(strIngredient3, strMeasure3));
        if (strIngredient4 != null && !strIngredient4.isEmpty()) list.add(new Pair<>(strIngredient4, strMeasure4));
        if (strIngredient5 != null && !strIngredient5.isEmpty()) list.add(new Pair<>(strIngredient5, strMeasure5));
        if (strIngredient6 != null && !strIngredient6.isEmpty()) list.add(new Pair<>(strIngredient6, strMeasure6));
        if (strIngredient7 != null && !strIngredient7.isEmpty()) list.add(new Pair<>(strIngredient7, strMeasure7));
        if (strIngredient8 != null && !strIngredient8.isEmpty()) list.add(new Pair<>(strIngredient8, strMeasure8));
        if (strIngredient9 != null && !strIngredient9.isEmpty()) list.add(new Pair<>(strIngredient9, strMeasure9));
        if (strIngredient10 != null && !strIngredient10.isEmpty()) list.add(new Pair<>(strIngredient10, strMeasure10));
        if (strIngredient11 != null && !strIngredient11.isEmpty()) list.add(new Pair<>(strIngredient11, strMeasure11));
        if (strIngredient12 != null && !strIngredient12.isEmpty()) list.add(new Pair<>(strIngredient12, strMeasure12));
        if (strIngredient13 != null && !strIngredient13.isEmpty()) list.add(new Pair<>(strIngredient13, strMeasure13));
        if (strIngredient14 != null && !strIngredient14.isEmpty()) list.add(new Pair<>(strIngredient14, strMeasure14));
        if (strIngredient15 != null && !strIngredient15.isEmpty()) list.add(new Pair<>(strIngredient15, strMeasure15));
        if (strIngredient16 != null && !strIngredient16.isEmpty()) list.add(new Pair<>(strIngredient16, strMeasure16));
        if (strIngredient17 != null && !strIngredient17.isEmpty()) list.add(new Pair<>(strIngredient17, strMeasure17));
        if (strIngredient18 != null && !strIngredient18.isEmpty()) list.add(new Pair<>(strIngredient18, strMeasure18));
        if (strIngredient19 != null && !strIngredient19.isEmpty()) list.add(new Pair<>(strIngredient19, strMeasure19));
        if (strIngredient20 != null && !strIngredient20.isEmpty()) list.add(new Pair<>(strIngredient20, strMeasure20));
        return list;
    }
